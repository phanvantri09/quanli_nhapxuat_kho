                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (Session::has('notice'))
                                    <div  class="alert alert-success bg-danger text-white">{{ Session::get('notice') }}</div>
                            @endif
                            <div class="form-validation">
                                <form action="{{ route('thukho.xuat.addPost') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="mb-3 row">
